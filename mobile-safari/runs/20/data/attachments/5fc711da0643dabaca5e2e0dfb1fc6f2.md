...
- Name: profile.spec.ts >> Profile settings @profile >> should login with updated credentials and restore original profile data
- Location: tests/e2e/profile.spec.ts:92:7
