...
- Name: profile.spec.ts >> Profile settings @profile >> should display validation errors when updating profile with invalid data
- Location: tests/e2e/profile.spec.ts:27:7
